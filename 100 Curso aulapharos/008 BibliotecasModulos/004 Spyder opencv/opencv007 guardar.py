...
greyRoto=grey.copy()  
greyRoto[100:300,200:300]= 188 #Cuadrado gris en la imagen en blaco y negro

cv2.imshow('image',greyRoto) #Mostramos la imagen gris
...
cv2.imwrite('redimension.jpg',grey)